function [trim_state, trim_thrust, trim_control, dLEF, xu] = trim_F16_modified(thrust, elevator, alpha, ail, rud, vel, alt, FC_flag,iter)
%================================================
...
dLEF = xu(17);disp('Trim Values and Cost:');
